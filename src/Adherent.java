...
public class Adherent {
	...
	private String respLegal; // Responsable l�gal: P�re || M�re || Autre (� pr�ciser)
	private String adresse;
	private long codePostal;
	private String ville;
	private String telParent;
	private String participation; // Au conseil de classe || � la bourse aux libres || au conseil d'administration
	private String formule; // formule "de base" � 15� || formule "soutien" � 25� || formule "bienfaiteur" � 39�
	private double acompte; // (Si pas de reprise pour ectte commande)
	private double montant;
	private Commande commande;
	private String typeLivre; // Neuf || Excellent �tat type 2 || Etat moyen type 3 || Etat passable 4 || Etat tr�s passable 5
	private int [] listeLivre; // Pourquoi pas ne p�s stocker que les ID des livres. De ce fait, pour afficher les livres, on fait livreDAO.selectById(idLivre[i])
